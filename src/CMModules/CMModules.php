...
/**
 * A model for managing Siteshop modules.
 *
...
class CMModules extends CObject {
     ...
     * Properties
     */
    private $siteshopCoreModules = array('CSiteshop', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
    private $siteshopCMFModules = array('CForm', 'CFormElement', 'CFormElementText', 'CFormElementTextarea', 'CFormElementTextTwit', 'CFormElementTextareaTwit', 'CFormElementHidden', 'CFormElementPassword', 'CFormElementPasswordTwit', 'CFormElementSubmit', 'CFormElementButton', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier', 'CTextFilter');
    ...
    private function GetDetailsOfModule($module) {
        ...
        if (class_exists($module)) {
            ...
            $details['isSiteshopCore'] = in_array($rc->name, $this->siteshopCoreModules);
            $details['isSiteshopCMF'] = in_array($rc->name, $this->siteshopCMFModules);
