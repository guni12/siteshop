...
<?php if($content['created']): ?>
        This content were created by <?=$content['owner']?> at <?=time_diff($content['created'])?>.
<?php else: ?>
Content not yet created.
<?php endif; ?>

<?php if(isset($content['updated'])):?>
Last updated at <?=time_diff($content['updated'])?>.
<?php endif; ?>
</em></p>

<p>
    <a href='<?=create_url('content', 'create')?>'>View all content</a>
