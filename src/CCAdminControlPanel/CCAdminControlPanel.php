    ...
    public function CreateContent($id = null) {
        ...
        $this->views->SetTitle($title . t('content: ') . htmlEnt($this->content['title']))
                ...
                ->AddIncludeToRegion('sidebar', __DIR__ . '/sideedit.tpl.php', array(
                    ...
                    'text21' => t('byline - one of the footers to the homepage'),
                    'text22' => t('secret1 - the secret main content'),
                    'text23' => t('secret2 - the secret sidebar content'),
                    'text24' => t('footer - one of the footers to the secret page'),
